...
<html lang="zxx">
    ...
    <body class="js">
        ...
        <form method="post" action="add">
            <td>Mã Sản phẩm:<input type="text" name="id"></td><br>
            <td>Tên sản phẩm:<input type="text" name="name"></td><br>
            <td>Giá:<input type="text" name="price"></td><br>
            <td>Số lượng:<input type="text" name="sl"></td><br>
            <td>Thể loại:<input type="text" name="cat"></td><br>
            <td>Mô tả:<input type="text" name="mt"></td><br>
            <td>Ảnh:<input type="text" name="image"></td><br>
        </form>
        <div class="row">
            <div class="col-12">
                <!-- Total Amount -->
