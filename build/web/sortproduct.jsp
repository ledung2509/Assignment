                    ...
                    <div class="col-12">
                        <div class="bread-inner">
                            <ul class="bread-list">
                                ...
                                <li class="active"><a href="viewproduct">Shop Grid</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        <div class="row">
                            <div class="col-12">
                                <!-- Shop Top -->  
                                <form action="sort" method="post" id="frm">                             
                                    <div class="shop-top">
                                        <div class="shop-shorter">
                                            <div class="single-shorter">
                                                ...
                                                <select name="op" onchange="change()">
                                                    ...
                                                    <option value="2">Giá lớn nhất</option>
                                                    <option value="3">Giá nhỏ nhỏ</option>
                                                </select>
                                                <script>
                                                    function  change() {
