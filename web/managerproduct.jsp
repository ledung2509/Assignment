        ...
        <div class="shopping-cart section">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- Shopping Summery -->
                        <form method="post" action="managerproduct">
                                ...
                                <tbody>
                                    <c:forEach items="${product}" var="o">
                                        <tr>
                                            ...
                                            <!--/ Mô tả -->
                                            <td class="total-amount" data-title="Total"><span>${o.getMaTheLoai()}</span></td>
                                            <td class="action" data-title="Edit"><a href="update?id=${o.getMaTraiCay()}">Chỉnh sửa</a></td>
                                            <td class="action" data-title="Remove"><a href="delete?id=${o.getMaTraiCay()}">Xóa</a></td>
