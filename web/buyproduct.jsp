                        ...
                        <div class="col-lg-2 col-md-3 col-12">
                            <div class="right-bar">
                                ...
                                <div class="sinlge-bar shopping">
                                    <a href="cart.jsp" class="single-icon"><i class="ti-bag"></i> <span class="total-count">${size}sp</span></a>
                                    <!-- Shopping Item -->
                    ...
                    <div class="col-12">
                        <div class="bread-inner">
                            <ul class="bread-list">
                                ...
                                <li class="active"><a href="#">Mua sản phẩm</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form method="post" action="" name="f">
                            Nhập số lượng cần mua:<input type="number" name="num" value="1"/><br><br>
                            <table class="table shopping-summery">
                                ...
                                <tbody>
                                    <c:forEach items="${product}" var="o">
                                        <tr>
                                            <td class="image" data-title="No"><img src=${o.getAnh()} alt="#"></td>
                                            <td class="product-des" data-title="Description">
                                                <p class="product-name"><a href="#">${o.getTenTraiCay()}</a></p>
                                            </td>
                                            <td class="price" data-title="Price"><span>${o.getGia()} VNĐ</span></td>
                                            <td class="qty" data-title="Qty"><!-- Input Order -->
                                                <div class="input-group">
                                                    ${o.soLuong}
                                                </div>
                                            </td>
                                            <td><input type="submit" onclick="buy(${o.maTraiCay})" value="Thêm vào giỏ hàng"></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
                        ...
                        <script>
                            function  buy(maTraiCay) {
                                document.f.action = "buy?maTraiCay=" + maTraiCay;
                                document.f.submit();
                            }
                        </script>
